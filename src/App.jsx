...
export default function App() {
  return (
    <div className="h-screen flex flex-col gap-4">
      <header className="border-b-2 py-2 px-5 flex flex-col gap-3 lg:flex-row lg:gap-20">
        <div className="font-bold text-4xl flex flex-col justify-center">
          <div>MoleCal</div>
        </div>
        <div className="flex flex-wrap gap-7 text-xl font-bold">
      ...
      <main className="flex px-3 justify-center">
        <Outlet />
      </main>
    </div>
  );
